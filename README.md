...
3. getWiki需要传入pageID，pageid就是比如“https://decathlon.atlassian.net/wiki/spaces/CHIN/pages/2338947945/W9_2026.02.27”这个中pages后面“2338947945”这段数字,你也可以直接贴confluence wiki的url
...
3. dify目前使用Qwen-plus-latest，目前使用下来这个模型幻觉会更少一点，提示词在"提示词.md"文档
